...
;; Adjust text to scroll in more natural feeling to me instead of the Emacs page jumps style.
(pixel-scroll-precision-mode 1)
(setq scroll-conservatively 101)  ; Never recenter point when scrolling
(setq scroll-margin 0)
(setq hscroll-step 1)
(setq hscroll-margin 0)
;; Horizontal scrolling with mouse.
(setq mouse-wheel-tilt-scroll t)
(setq mouse-wheel-scroll-amount-horizontal 5)
...
;; TODO: something is making editing slow for large files maybe?
;;    copying and pasting
...
(use-package evil
  ...
  (evil-define-key 'normal 'global
	...
	(kbd "<leader>o") 'dired
	(kbd "<leader>tw") 'my-toggle-whitespace

	(kbd "<leader>sf") 'counsel-projectile-find-file
	(kbd "<leader>pp") 'counsel-projectile-switch-project
	(kbd "<leader>pg") 'counsel-projectile-rg
  )
...
(use-package rg
  ...
  (evil-define-key 'normal rg-mode
...
(use-package corfu
  ...
  (setq corfu-auto-delay 0.1)            ; Same delay as your company setup
  (setq corfu-auto-prefix 2)             ; Start after 2 characters
  (setq corfu-cycle t)                   ; Enable cycling through candidates
  
  ;; Same keybinds as your Company config
  (define-key corfu-map (kbd "C-n") 'corfu-next)
  (define-key corfu-map (kbd "C-p") 'corfu-previous)
  (define-key corfu-map (kbd "C-y") 'corfu-insert)
  
  ;; Disable default keymaps (like you did with Company)
...
(defun my-toggle-whitespace ()
  "Toggle showing whitespace characters tabs/spaces"
  (interactive)
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company corfu counsel counsel-projectile evil-mc hl-todo
			 idea-darkula-theme projectile rg rust-mode smex web-mode)))
(custom-set-faces
